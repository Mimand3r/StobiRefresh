...
class FirestoreWorker {
  static Future<void> writeUserToDb(DbUser user) async {
  ...
  static Future<DbUser> readUserFromDb(String uId) async {
    var snap = await Firestore.instance.collection("users").document(uId).get();

    if (snap.data == null) return null;

    return DbUser.fromSnapshot(snap);
  }
  ...
  static Future<void> clearUnreadForConversation(
      DbUser user, String convId) async {
